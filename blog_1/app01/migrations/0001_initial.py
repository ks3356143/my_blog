# Generated by Django 3.2.6 on 2022-06-14 03:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sign_status', models.IntegerField(choices=[(0, '用户注册'), (1, '手机号注册'), (0, '邮箱注册'), (0, 'QQ注册')], default=0, verbose_name='注册方式')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_show', models.IntegerField(default=False, verbose_name='是否展示')),
                ('author', models.CharField(blank=True, max_length=32, null=True, verbose_name='广告主')),
                ('abstract', models.CharField(blank=True, max_length=128, null=True, verbose_name='产品介绍')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_date', models.DateTimeField(auto_now_add=True, null=True, verbose_name='文章创建日期')),
                ...
                ('category', models.IntegerField(blank=True, choices=[(0, '收藏'), (1, '后端')], null=True, verbose_name='文章分类')),
                ('auther', models.CharField(blank=True, max_length=16, null=True, verbose_name='作者')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wechat_url', models.FileField(upload_to='', verbose_name='微信头像')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('nid', models.AutoField(primary_key=True, serialize=False)),
                ('icon_href', models.URLField(blank=True, help_text='在线连接', null=True, verbose_name='图片链接')),
                ...
                ('nav_category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app01.navcategory', verbose_name='网站导航分类')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('digg_count', models.IntegerField(default=0, verbose_name='评论数')),
                ('avator', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app01.avatars', verbose_name='心情发布的头像')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app01.avatars', verbose_name='心情发布头像')),
                ('mood', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app01.moods', verbose_name='评论心情')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=32, null=True, verbose_name='slogen')),
                ('abstract', models.TextField(help_text='多个之间按分号区分', null=True, verbose_name='slogen介绍')),
                ('abstract_time', models.IntegerField(default=8, help_text='单位秒，默认8秒', verbose_name='slogen切换时间')),
                ('rotation', models.BooleanField(default=True, verbose_name='是否轮播slogen介绍')),
                ('menu_rotation', models.BooleanField(default=False, help_text='多选默认会轮播', verbose_name='是否轮播banner图')),
                ('menu_time', models.IntegerField(default=8, help_text='单位秒,默认为8秒', verbose_name='轮播图切换时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_comment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app01.comment', verbose_name='是否为父评论')),
